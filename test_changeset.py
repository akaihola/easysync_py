...
@pytest.mark.parametrize(
    ...
    [(["apple\n",
      ...
      ["tuple\n",
       ...
       "bubba\n",
       "eggplant\n"],
      [((0, 1), (0, 1), 'remove', [1, 0, 'a']),
       ((0, 1), (0, 1), 'insert', ['tu']),
       ((0, 1), (0, 1), 'remove', [1, 0, 'p']),
       ((2, 2), (2, 4), 'insert', ['cream\npie\n', 2]),
       ((2, 3), (4, 5), 'insert', ['bot']),
       ((2, 3), (4, 5), 'insert', ['\n', 1]),
       ((2, 3), (5, 6), 'insert', ['bu']),
       ((2, 4), (5, 6), 'remove', [3, 1, 'ge\n']),
       ((3, 4), (5, 6), 'remove', [6, 0, 'duffle'])]),
     ...
     (["apple\n",
      ...
      ["banana\n",
       "cabbage\n",
       "duffle\n"],
      [((0, 2), (0, 1), 'remove', [6, 1, 'apple\n']),
       ((3, 5), (2, 3), 'remove', [1, 1, '\n']),
       ((4, 5), (2, 3), 'remove', [8, 0, 'eggplant'])]),
